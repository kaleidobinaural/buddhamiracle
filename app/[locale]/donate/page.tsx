...
const REAL_TIERS = [
  {
    ...
    lotusReward: 10,
    icon: '🕯️',
    desc: 'Light a single flame in the sanctuary. Your light joins the collective glow.',
  ...
  },
  {
    ...
    lotusReward: 60,
    icon: '🪷',
    desc: 'Offer a lotus. Your name joins the Serenity Pillar on the temple wall.',
  ...
  },
  {
    ...
    lotusReward: 300,
    icon: '🏛️',
    desc: 'Erect a Pillar of Light with your name engraved permanently in virtual marble.',
    paypalItem: 'Temple+of+Light+Pillar+Offering',
  },
];
