  ...
  return (
    <main className="store-page">
      ...
      <style>{`
        ...
        .store-section { position: relative; z-index: 1; max-width: 1200px; margin: 0 auto; padding: calc(var(--nav-height) + 20px) 24px 20px; }
        .store-hero { text-align: center; padding-top: 0; }
